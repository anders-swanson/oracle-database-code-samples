...
The [OracleDatabaseContainer](oracle_database_container.py) class implements a Testcontainers database container for Oracle AI Database Free, using the `gvenzl/oracle-free:23.26.3-slim-faststart` image by default.
...
```
Pulling image gvenzl/oracle-free:23.26.3-slim-faststart
