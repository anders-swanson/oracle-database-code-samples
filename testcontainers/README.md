...
The `gvenzl/oracle-free` Oracle Database container images are recommended for use with Testcontainers and Java. The examples in this module use the Oracle Database 26ai Free image `gvenzl/oracle-free:23.26.1-slim-faststart`.
