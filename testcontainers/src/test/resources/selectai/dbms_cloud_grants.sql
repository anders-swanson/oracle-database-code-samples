...
grant select on testuser.students to selectai;
grant select on testuser.courses to selectai;
grant select on testuser.enrollments to selectai;
grant select on testuser.lecture_halls to selectai;
