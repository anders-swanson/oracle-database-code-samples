...
The example test starts `gvenzl/oracle-free:23.26.3-slim-faststart`, waits for the database to become ready, and connects with the application user created by the container environment variables.
